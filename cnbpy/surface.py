...
class Subsurface(object):
    ...
    def generate(self):
        ...
        self.dangling_vertex_mask_L=self.subsurface_L.subsurface_vertex_mask[self.boolmasks[0]]
        self.dangling_vertex_mask_R=self.subsurface_R.subsurface_vertex_mask[self.boolmasks[1]]
    ...
    def make_laplacians(self,n_components):
        self.L_eigenvalues,self.L_eigenvectors=self.laplacian_decomposition(self.subsurface_L,n_components)
        self.R_eigenvalues,self.R_eigenvectors=self.laplacian_decomposition(self.subsurface_R,n_components)
