...
yaml_file=os.path.join(DATA_PATH,'mriqc_config.yml')
template_file=os.path.join(DATA_PATH,'template_mriqc.sh')

class MRIQC:
    
    """MRIQC
    Class for running an mriqc job using slurm.
    ...
    def __init__(self,yaml_file=yaml_file,template_file=template_file,jobname='mymriqc',pid='allsubs'):
        
        """
        Initialise the MRIQC class.
        
        Parameters
        ----------
        yaml_file: yaml file containing the information to be fed into the mriqc jobscript (provided in repo).
        ...
        self.c_dict= self.yaml['call'] # Things to be added to the call to mriqc.
    ...
    def make_out_paths(self):
        ...
        self.out_path: The location for the outputs of mriqc to be stored.
